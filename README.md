...
if command -v curl >/dev/null 2>&1; then
  sh -c "$(curl -fsSL https://raw.githubusercontent.com/m-kutnik/zsh4humans/v5/install)"
else
  sh -c "$(wget -O- https://raw.githubusercontent.com/m-kutnik/zsh4humans/v5/install)"
fi
```

...
if '[' '-n' "${Z4H-}" ']' &&
   '[' "${Z4H_URL-}" '=' 'https://raw.githubusercontent.com/m-kutnik/zsh4humans/v5' ']' &&
...
if '[' '-n' "${_z4h_bootstrap-}" ']'; then
  ...
  (
    ...
    if '[' '-z' "${Z4H_URL-}" ']'; then
      ...
      >&2 'printf' '\n'
      >&2 'printf' '  Z4H_URL=\033[33m"https://raw.githubusercontent.com/m-kutnik/zsh4humans/v5"\033[0m\n'
      'exit' '1'
    fi

    v="${Z4H_URL#https://raw.githubusercontent.com/m-kutnik/zsh4humans/v}"
    ...
    if '[' "v$v" '!=' 'v5' ']'; then
      ...
      >&2 'printf' 'Expected:\n'
      >&2 'printf' '\n'
      >&2 'printf' '  Z4H_URL=\033[33m"%s"\033[0m\n' "https://raw.githubusercontent.com/m-kutnik/zsh4humans/v5"
      >&2 'printf' '\n'
      >&2 'printf' 'Found:\n'
      >&2 'printf' '\n'
      >&2 'printf' '  Z4H_URL=\033[33m"%s"\033[0m\n' "$Z4H_URL"
    ...
    (
      ...
      if '[' '-z' "${Z4H_BOOTSTRAP_COMMAND-}" ']'; then
        url="https://github.com/m-kutnik/zsh4humans/archive/v$v.tar.gz"
...
if command -v 'curl' >'/dev/null' 2>&1; then
  ...
  >&2 'printf' '\n'
  >&2 'printf' '  \033[32msh\033[0m -c \033[33m"\033[0m$(\033[32mcurl\033[0m -fsSL \033[4mhttps://raw.githubusercontent.com/m-kutnik/zsh4humans/v5/install\033[0m)\033[33m"\033[0m\n'
elif command -v 'wget' >'/dev/null' 2>&1; then
  >&2 'printf' '\n'
  >&2 'printf' 'Give up and start over:\n'
  >&2 'printf' '\n'
  >&2 'printf' '  \033[32msh\033[0m -c \033[33m"\033[0m$(\033[32mwget\033[0m -O- \033[4mhttps://raw.githubusercontent.com/m-kutnik/zsh4humans/v5/install\033[0m)\033[33m"\033[0m\n'
fi
